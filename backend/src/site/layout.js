...
var COPY={INVALID_REQUEST:"Please enter a valid video URL.",INVALID_URL:"That link doesn\\u2019t look valid. Check it and try again.",UNSUPPORTED_PLATFORM:"This platform is not currently supported.",PRIVATE_CONTENT:"This video isn\\u2019t publicly downloadable.",VIDEO_PRIVATE:"This video isn\\u2019t publicly downloadable.",VIDEO_NOT_FOUND:"This video was not found or is unavailable.",UPSTREAM_REJECTED:"YouTube is refusing requests from our server right now — try again later.",FORMAT_NOT_AVAILABLE:"The selected quality is unavailable — pick another.",MERGE_FAILED:"Merging failed — try a lower quality.",PROCESSING_FAILED:"We couldn\\u2019t process this video. Try again.",PROCESSING_TIMEOUT:"The request took too long and was stopped.",OUTPUT_TOO_LARGE:"The file is too large.",FILE_TOO_LARGE:"The file is too large.",RATE_LIMITED:"Too many requests — try again later.",NETWORK_ERROR:"Couldn\\u2019t reach the service. Try again.",SERVER_ERROR:"Something went wrong. Try again."};
